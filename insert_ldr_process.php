...
<html>
<head>
    <title>Insert LDR Information</title>
    <style>
...
<body>
    <div class="container">
        ...
        // Prepare and execute the SQL statement to insert data into the ldr_info table
        $sql = "INSERT INTO ldr_info (ldr, barcode) VALUES (?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("is", $ldr, $barcode);

        if ($stmt->execute()) {
            // If insertion is successful, display a success message
            echo "<p class='message'>LDR information inserted successfully</p>";
        } else {
