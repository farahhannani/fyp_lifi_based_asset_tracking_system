    ...
    <div class="w3-top">
        <div class="w3-bar w3-wide w3-padding w3-card"> <!-- Match the dashboard header color -->
            ...
            <div class="w3-right w3-hide-small">
                <a href="manage_ldrs.php" class="w3-bar-item w3-button">Back</a>
            </div>
        </div>
    </div>
</header>
...
<div class="container">
    <h1 class="heading">Insert LDR Information</h1>
    <div class="content">
        <form action="insert_ldr_process.php" method="post">
            <label for="ldr">LDR Number</label><br>
            ...
            <input type="submit" value="Add LDR">
        </form>
    </div>
</div>
