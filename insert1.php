...
$table = "location_tracking_aa00"; // Change this to the table name for barcode AA00
...
if (!empty($location)) {
    ...
    $sql = "INSERT INTO $table (ldr, barcode, location, timestamp) VALUES (1, 'AA00', ?, NOW())"; // Assuming you also have a timestamp column
