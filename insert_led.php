    ...
    <div class="w3-top">
        <div class="w3-bar w3-wide w3-padding w3-card"> <!-- Match the dashboard header color -->
            ...
            <div class="w3-right w3-hide-small">
                <a href="manage_leds.php" class="w3-bar-item w3-button">Back</a>
            </div>
        </div>
    </div>
</header>
...
<div class="container">
    <h1 class="heading">Insert LED Information</h1>
    <div class="content">
        <form action="insert_led_process.php" method="post">
            <label for="led_id">LED ID</label><br>
            <input type="number" id="led_id" name="led_id" required><br><br>
            
            <label for="location">Location</label><br>
            <input type="text" id="location" name="location" required><br><br>
            
            <input type="submit" value="Add LED">
        </form>
    </div>
</div>
