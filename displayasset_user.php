...
<head>
    ...
    <style>
        ...
        table {
            width: 900px; /* Set width to 60% of the page */
    ...
    <section>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>".$row["ldr"]."</td>";
                echo "<td><a href='viewlocationuser.php?barcode=".$row["barcode"]."' class='btn'><i class='fas fa-map-marker-alt'></i></a></td>"; // Font Awesome icon for location
                echo "<td><a href='viewdetailsuser.php?barcode=".$row["barcode"]."' class='btn'><i class='fas fa-info-circle'></i></a></td>"; // Font Awesome icon for details
                echo "</tr>";
            }
            echo "</table>";
        } else {
