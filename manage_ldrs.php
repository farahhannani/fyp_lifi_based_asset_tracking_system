    ...
    <div class="main-container">
        ...
        <div class="main">
            <div class="box-container">
                <a href="ldr_list.php" class="box box1">
                    <img src="https://cdn-icons-png.flaticon.com/512/10650/10650271.png" alt="View Assets List">
                    <div class="text">
                        <h2>View LDRs List</h2>
                    </div>
                </a>

                <a href="insert_ldr.php" class="box box2">
                    <img src="https://cdn.iconscout.com/icon/premium/png-256-thumb/ldr-2915050-2413952.png?f=webp" alt="Add New Asset">
                    <div class="text">
                        <h2>Add New LDR</h2>
                    </div>
                </a>
